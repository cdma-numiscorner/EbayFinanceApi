...
namespace OpenAPI\EbayFinanceApiClient\Api;
...
use OpenAPI\EbayFinanceApiClient\HeaderSelector;
...
class PayoutApi
{
     ...
     *
     * @throws \OpenAPI\EbayFinanceApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\EbayFinanceApiClient\Model\Payout
     */
     ...
     * @throws \OpenAPI\EbayFinanceApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\EbayFinanceApiClient\Model\Payout, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPayoutWithHttpInfo($payout_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\EbayFinanceApiClient\Model\Payout' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\EbayFinanceApiClient\Model\Payout' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\EbayFinanceApiClient\Model\Payout', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\EbayFinanceApiClient\Model\Payout';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\EbayFinanceApiClient\Model\Payout',
     ...
     * @throws \OpenAPI\EbayFinanceApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\EbayFinanceApiClient\Model\PayoutSummaryResponse
     */
     ...
     * @throws \OpenAPI\EbayFinanceApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\EbayFinanceApiClient\Model\PayoutSummaryResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPayoutSummaryWithHttpInfo($filter = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\EbayFinanceApiClient\Model\PayoutSummaryResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\EbayFinanceApiClient\Model\PayoutSummaryResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\EbayFinanceApiClient\Model\PayoutSummaryResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\EbayFinanceApiClient\Model\PayoutSummaryResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\EbayFinanceApiClient\Model\PayoutSummaryResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \OpenAPI\EbayFinanceApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\EbayFinanceApiClient\Model\Payouts
     */
    public function getPayouts($filter = null, $limit = null, $offset = null, $sort = null)
    {
        list($response) = $this->getPayoutsWithHttpInfo($filter, $limit, $offset, $sort);
        return $response;
    }
     ...
     * @throws \OpenAPI\EbayFinanceApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\EbayFinanceApiClient\Model\Payouts, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPayoutsWithHttpInfo($filter = null, $limit = null, $offset = null, $sort = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\EbayFinanceApiClient\Model\Payouts' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\EbayFinanceApiClient\Model\Payouts' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\EbayFinanceApiClient\Model\Payouts', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\EbayFinanceApiClient\Model\Payouts';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\EbayFinanceApiClient\Model\Payouts',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
