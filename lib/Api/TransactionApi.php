...
class TransactionApi
{
     ...
     * @return \OpenAPI\EbayFinanceApiClient\Model\TransactionSummaryResponse
     */
     ...
     * @throws \OpenAPI\EbayFinanceApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\EbayFinanceApiClient\Model\TransactionSummaryResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTransactionSummaryWithHttpInfo($filter = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\EbayFinanceApiClient\Model\TransactionSummaryResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\EbayFinanceApiClient\Model\TransactionSummaryResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\EbayFinanceApiClient\Model\TransactionSummaryResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\EbayFinanceApiClient\Model\TransactionSummaryResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\EbayFinanceApiClient\Model\TransactionSummaryResponse',
     ...
     * @throws \OpenAPI\EbayFinanceApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\EbayFinanceApiClient\Model\Transactions
     */
    public function getTransactions($filter = null, $limit = null, $offset = null, $sort = null)
    {
        list($response) = $this->getTransactionsWithHttpInfo($filter, $limit, $offset, $sort);
        return $response;
    }
     ...
     * @throws \OpenAPI\EbayFinanceApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\EbayFinanceApiClient\Model\Transactions, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTransactionsWithHttpInfo($filter = null, $limit = null, $offset = null, $sort = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\EbayFinanceApiClient\Model\Transactions' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\EbayFinanceApiClient\Model\Transactions' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\EbayFinanceApiClient\Model\Transactions', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\EbayFinanceApiClient\Model\Transactions';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\EbayFinanceApiClient\Model\Transactions',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
