...
class TransferDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'balance_adjustment' => '\OpenAPI\EbayFinanceApiClient\Model\BalanceAdjustment',
        'charges' => '\OpenAPI\EbayFinanceApiClient\Model\Charge[]',
        'total_charge_net_amount' => '\OpenAPI\EbayFinanceApiClient\Model\Amount'
    ];
     ...
     *
     * @return \OpenAPI\EbayFinanceApiClient\Model\BalanceAdjustment|null
     */
     ...
     *
     * @param \OpenAPI\EbayFinanceApiClient\Model\BalanceAdjustment|null $balance_adjustment balance_adjustment
     *
     * @return self
     */
     ...
     * Gets charges
     *
     * @return \OpenAPI\EbayFinanceApiClient\Model\Charge[]|null
     */
     ...
     * Sets charges
     *
     * @param \OpenAPI\EbayFinanceApiClient\Model\Charge[]|null $charges This container is an array of one or more charges related to the transfer. Charges can be related to an order cancellation, order return, case, payment dispute, etc.
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\EbayFinanceApiClient\Model\Amount|null $total_charge_net_amount total_charge_net_amount
     *
     * @return self
     */
